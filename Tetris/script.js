...
document.getElementById('modeButton').addEventListener('click', chooseGameMode);
document.getElementById('exitButton').addEventListener('click', exitGame);

function startGame() {
  document.querySelector('.menu').style.display = 'none';  // Menyembunyikan menu
  document.getElementById('gameContainer').style.display = 'grid';  // Menampilkan grid permainan
  // Logika untuk memulai permainan Tetris
}

function chooseGameMode() {
  alert('Choose a game mode');  // Anda bisa menambahkan fungsionalitas lebih lanjut untuk memilih mode permainan
}

function exitGame() {
  window.close();  // Menutup jendela permainan
}
document.getElementById('startButton').addEventListener('click', startGame);
document.getElementById('modeButton').addEventListener('click', chooseGameMode);
document.getElementById('exitButton').addEventListener('click', exitGame);
